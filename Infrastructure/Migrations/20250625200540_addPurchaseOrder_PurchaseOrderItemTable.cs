...
{
    /// <inheritdoc />
    public partial class addPurchaseOrder_PurchaseOrderItemTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_PurchaseOrder_TotalCost_Positive", "[TotalCost] >0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_PurchaseOrderItem_OrderQuantity_Positive", "[OrderQuantity] > 0");
                    table.ForeignKey(
